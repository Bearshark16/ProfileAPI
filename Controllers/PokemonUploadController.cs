...
{
    [Route("api/pokemon/upload")]
    [ApiController]
    //[ApiKeyAuth]
    public class PokemonUploadController : ControllerBase
    {
        private IHostingEnvironment env;

        private string envPath;

        public PokemonUploadController(IHostingEnvironment _env)
        {
            env = _env;
            envPath = env.ContentRootPath + @"\Profiles\Pokemon\";
        }
        ...
        public async Task<ActionResult> ImageFileDownload(string name)
        {
            ...
            //string path = envPath + "jacob" + @"\" + "jacob" + ".png";
